...
<html>
    ...
    <body class="verticalscroll" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" onload="load()">
                        ...
                        <tr>
							...
							<div class="custom-select-wrapper">
								...
								<div class="custom-options">
									<c:forEach var="item" items="${PickingBean.orderList}">
										<div class="custom-option" data-value="${item.value}">${item.label}</div>
									</c:forEach>
								</div>
								<h:inputHidden id="hiddenSelect" value="#{PickingBean.selectedOrder}" />
							</div>
						</td>
                        </tr>
					</table>
        ...
        <script type="text/javascript">
            ...
            function setFocus() {
               //var s = document.getElementById('Form:input1').focus();
            }    
